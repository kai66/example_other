...
public class AnimUtil {
     ...
     */
    public static AnimUtil newInstance(Context context,View hideView,View down,int height){
        return new AnimUtil(context,hideView,down,height);
    }

    private AnimUtil(Context context,View hideView,View down,int height){
