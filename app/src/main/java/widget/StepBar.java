...
import android.view.View;
 ...
 class StepBar extends View {
    ...
    private boolean isError =true;//最后一步是否为错
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mErrorPaint.setColor(0Xffff6666);
        //end
        ...
        for(int i=0;i<mCompleteStep;i++){
            ...
            if(i==mCompleteStep-1){
                ...
                if(isError) {
                    canvas.drawCircle(xLoc, mLeftY, mLargeRadius, mErrorPaint);

                    canvas.drawLine(Float.valueOf(String.valueOf(xLoc-mLargeRadius*0.707 +mLargeRadius/3)).floatValue(),
                            Float.valueOf(String.valueOf(mLeftY-mLargeRadius*0.707+mLargeRadius/3)).floatValue(),
                            Float.valueOf(String.valueOf(xLoc+mLargeRadius*0.707-mLargeRadius/3)).floatValue(),
                            Float.valueOf(String.valueOf(mLeftY+mLargeRadius*0.707-mLargeRadius/3)).floatValue(),mWhitePaint);
