...
public class RightMarkView extends View {
     ...
     * 动画执行时间
     */
    public static final int ANIMATOR_TIME = 1500;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (!isAnyOneAtMost) {
            // 将宽高中小的值 realSize 与 defaultSize 比较，取大的值
            realSize = Math.max(realSize, defaultSize);
    ...
    private void initCircleAnimator() {
        ...
        // 插值器
       // mCircleValueAnimator.setInterpolator(new AccelerateInterpolator());
    ...
    private void initMarkAnimator() {
        ...
        // 插值器
       // mRightMarkValueAnimator.setInterpolator(new AccelerateInterpolator());
    }
