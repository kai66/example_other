...
public class RelativeLayoutTextView extends RelativeLayout{
    ...
    private int leftImgWidth;//左边图片宽带
    private int leftImgHeight;//左边图片高度
    private int rightImgWidth;//右边图片宽带
    ...
    public RelativeLayoutTextView setOnTextViewClickListener(OnTextViewClickListener listener) {
        this.OnTextViewClickListener = listener;
        return this;
    }

    public RelativeLayoutTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void initAttr(AttributeSet attrs) {
        TypedArray typedArray = mContext.obtainStyledAttributes(attrs, R.styleable.RelativeLayoutTextView);
        leftTvString = typedArray.getString(R.styleable.RelativeLayoutTextView_leftTvString);
        rightTvString = typedArray.getString(R.styleable.RelativeLayoutTextView_rightTvString);
        centerTvString = typedArray.getString(R.styleable.RelativeLayoutTextView_centerTvString);
        leftTopTvString = typedArray.getString(R.styleable.RelativeLayoutTextView_leftTopTvString);
        leftBottomTvString = typedArray.getString(R.styleable.RelativeLayoutTextView_leftBottomTvString);
        leftTvSize = typedArray.getDimensionPixelOffset(R.styleable.RelativeLayoutTextView_leftTvSize, 16);
        rightTvSize = typedArray.getDimensionPixelOffset(R.styleable.RelativeLayoutTextView_rightTvSize, 16);
        centerTvSize = typedArray.getDimensionPixelOffset(R.styleable.RelativeLayoutTextView_centerTvSize, 16);
        leftImgRes = typedArray.getDrawable(R.styleable.RelativeLayoutTextView_leftImg);
        rightImgRes = typedArray.getDrawable(R.styleable.RelativeLayoutTextView_rightImg);
        leftTvColor = typedArray.getColor(R.styleable.RelativeLayoutTextView_leftTvColor, defaultTvColor);
        rightTvColor = typedArray.getColor(R.styleable.RelativeLayoutTextView_rightTvColor, defaultTvColor);
        centerTvColor = typedArray.getColor(R.styleable.RelativeLayoutTextView_centerTvColor, defaultTvColor);
        leftImgWidth = typedArray.getDimensionPixelOffset(R.styleable.RelativeLayoutTextView_leftImgWidth, 0);
        leftImgHeight = typedArray.getDimensionPixelOffset(R.styleable.RelativeLayoutTextView_leftImgHeight, 0);
        rightImgWidth = typedArray.getDimensionPixelOffset(R.styleable.RelativeLayoutTextView_rightImgWidth, 0);
        rightImgHeight = typedArray.getDimensionPixelOffset(R.styleable.RelativeLayoutTextView_rightImgHeight, 0);
        leftTvMarginleft = typedArray.getDimensionPixelOffset(R.styleable.RelativeLayoutTextView_leftTvMarginleft, 0);
        rightTvMarginright = typedArray.getDimensionPixelOffset(R.styleable.RelativeLayoutTextView_rightTvMarginright, 0);
        leftImgMarginleft = typedArray.getDimensionPixelOffset(R.styleable.RelativeLayoutTextView_leftImgMarginleft, 0);
        rightImgMarginright = typedArray.getDimensionPixelOffset(R.styleable.RelativeLayoutTextView_rightImgMarginright, 0);
        bottomLineMargin = typedArray.getDimensionPixelOffset(R.styleable.RelativeLayoutTextView_bottomLineMargin, 0);
        bottomLineShow = typedArray.getBoolean(R.styleable.RelativeLayoutTextView_bottomLineShow, false);
        bottomLineHeight = typedArray.getDimensionPixelOffset(R.styleable.RelativeLayoutTextView_bottomLineHeight, 1);
        bottomcolor = typedArray.getColor(R.styleable.RelativeLayoutTextView_bottomcolor, defaultTvColor);
        centerTVMarginleft = typedArray.getDimensionPixelOffset(R.styleable.RelativeLayoutTextView_centerTVMarginleft, 0);
        leftTopTvMarginTop = typedArray.getDimensionPixelOffset(R.styleable.RelativeLayoutTextView_leftTopTvMarginTop, 0);
        leftTopTvMarginleft = typedArray.getDimensionPixelOffset(R.styleable.RelativeLayoutTextView_leftTopTvMarginleft, 0);
        leftBottomTvMarginleft = typedArray.getDimensionPixelOffset(R.styleable.RelativeLayoutTextView_leftBottomTvMarginleft, 0);
        leftButtomTvMarginBottom = typedArray.getDimensionPixelOffset(R.styleable.RelativeLayoutTextView_leftButtomTvMarginBottom, 0);
        leftTopTvSize = typedArray.getDimensionPixelOffset(R.styleable.RelativeLayoutTextView_leftTopTvSize, 16);
        leftBottomTvSize = typedArray.getDimensionPixelOffset(R.styleable.RelativeLayoutTextView_leftBottomTvSize, 16);
        leftTopTvColor = typedArray.getColor(R.styleable.RelativeLayoutTextView_leftTopTvColor, defaultTvColor);
        leftBottomTvColor = typedArray.getColor(R.styleable.RelativeLayoutTextView_leftBottomTvColor, defaultTvColor);
    ...
    //代码设置左边文字
    public RelativeLayoutTextView setLeftTv(String tvStr, String tvColor) {
    ...
    //代码设置右边文字
    public RelativeLayoutTextView setRightTv(String tvStr, String tvColor) {
    ...
    //代码设置中间文字
    public RelativeLayoutTextView setCenterTv(String tvStr, String tvColor) {
    ...
    //代码设置左上文字颜色
    public RelativeLayoutTextView setLeftTopTv(String tvStr,String tvColor){
    ...
    //代码设置左下文字颜色
    public RelativeLayoutTextView setLeftBottomTv(String tvStr,String tvColor){
    ...
    //代码设置布局背景颜色
    public RelativeLayoutTextView setCustomTvBackground(String strColor){
        RelativeLayoutTextView.this.setBackgroundColor(Color.parseColor(strColor));
        return this;
    }


    //代码设置左边图片
    public RelativeLayoutTextView setLeftImg(Drawable icRes) {
        leftImgRes = icRes;
        if (leftIV == null) {
            initLeftImg();
        } else {
    ...
    //代码设置右边图片
    public RelativeLayoutTextView setRightImg(Drawable icRes) {
        rightImgRes = icRes;
        if (rightIV == null) {
            initRightImg();
        } else {
    ...
    //设置下划线
    public RelativeLayoutTextView setBottomLine(String color) {
    ...
    private void initLeftImg() {
        ...
        int width = leftImgWidth != 0 ? leftImgWidth : LayoutParams.WRAP_CONTENT;
    ...
    private void initRightImg() {
        ...
        int width = rightImgWidth != 0 ? rightImgWidth : LayoutParams.WRAP_CONTENT;
